...
try:
    # Prefer the installed garmin_fit_sdk package when available
    ...
    # Fall back to the source files bundled alongside this package
    from .accumulator import Accumulator
    from .bitstream import BitStream
    from .crc_calculator import CrcCalculator
    from .decoder import Decoder
    from .fit import BASE_TYPE, BASE_TYPE_DEFINITIONS
    from .hr_mesg_utils import expand_heart_rates
    from .profile import Profile
    from .stream import Stream
    from .util import FIT_EPOCH_S, convert_timestamp_to_datetime
